...
public class organizerlogin extends JFrame {
	...
	public organizerlogin() {
		...
		private void initialize() {
			...
			btnNewButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
			        ...
			        try {
			            ...
			            String sql= "SELECT * FROM  eventorganizer where username='" +user.getText() +"' AND password='" +pass.getText()+"' ";
			...
			lblNewLabel_3.setBounds(529, 205, 796, 68);
			lblNewLabel_3.setForeground(new Color(0, 0, 0));
			lblNewLabel_3.setFont(new Font("Times New Roman", Font.BOLD, 62));
			panel_1.add(lblNewLabel_3);
			btnNewButton_1.addActionListener(new ActionListener() {
			    public void actionPerformed(ActionEvent e) {
			    	organizerregister registerFrame = new organizerregister();
